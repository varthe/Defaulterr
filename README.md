...
Change the default audio stream for items in Plex per user based on codec, language, keywords, and more. Customizable with filters and groups. Can run on a schedule or for newly added items using a Tautulli webhook.
